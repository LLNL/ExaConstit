...
rm -rf *
# GPU build
cmake ../ -DCMAKE_INSTALL_PREFIX=../install_dir/ -DRAJA_DIR=${BASE_DIR}/raja/install_dir/share/raja/cmake/ -DENABLE_OPENMP=OFF -DENABLE_CUDA=ON -DENABLE_TESTS=ON -DENABLE_MINIAPPS=OFF -DCMAKE_BUILD_TYPE=Release -DCUDA_ARCH=${LOC_CUDA_ARCH} -DBUILD_SHARED_LIBS=OFF
# CPU only build
