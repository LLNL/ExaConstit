...
void
PartialQuadratureSpace::ConstructOffsets() {
...
void
PartialQuadratureSpace::ConstructGlobalOffsets() {
    // Set up offsets based on our partial element set
...
void
PartialQuadratureSpace::Construct() {
...
void
PartialQuadratureSpace::ConstructMappings(std::shared_ptr<mfem::Mesh> mesh_, mfem::Array<bool>& partial_index) {
...
void
PartialQuadratureSpace::Save(std::ostream &out) const
{
