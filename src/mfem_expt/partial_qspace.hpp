...
protected:
     ...
     * The global2local array maps from global element index to local element index (-1 if not included).
     */
...
public:
     ...
     * @param partial_index Boolean array indicating which elements to include in the partial set
     * 
     * @deprecated Use constructor with std::shared_ptr<mfem::Mesh> instead for better memory management
     */
