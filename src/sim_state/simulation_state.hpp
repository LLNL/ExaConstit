...
private:
    ...
    struct OrientationConfig {
        ...
        /** @brief Number of components per orientation (4 for quaternions, 3 for Euler angles, etc.) */
        int stride;
    ...
    /** @brief Shared orientation data for crystal plasticity (temporary storage during initialization) */
