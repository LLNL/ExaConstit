...
/**
 * @brief Nonlinear form integrator for general solid mechanics problems with material model integration.
 * 
...
class ExaNLFIntegrator : public mfem::NonlinearFormIntegrator
{
   ...
   public:
       ...
       * Applies the transformation: D_ijkm = (1/det(J)) * w_qpt * adj(J)^T_ij * C^tan_ijkl * adj(J)_lm
       * where:
