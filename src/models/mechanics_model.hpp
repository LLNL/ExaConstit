 ...
 * 3. Computing the incremental deformation gradient as the transpose multiplication of element coordinates with shape function gradients
...
class ExaModel
{
   ...
   public:
       ...
       * 
       * @details This function is responsible for running the entire model and consists of 3 stages/kernels:
