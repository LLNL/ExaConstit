...
class ExaCMechModel : public ExaModel
{
   ...
   public:
       ...
       * 1. **Preprocessing**: Computes velocity gradients, deformation rates, and other kinematic quantities
       * 2. **Material Model**: Calls ExaCMech crystal plasticity kernel to compute stress and tangent stiffness
