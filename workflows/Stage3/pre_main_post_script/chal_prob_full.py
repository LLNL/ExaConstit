...
def exaconstit_preprocess(args, output_directory):
    ...
    for itemp in range(len(tempk)):
        for i in range(nruns):
            ...
            if (loading_name[i] == "x_0_y_90" or loading_name[i] == "x_90_z_0"):
...
if __name__ == "__main__":
    ...
    path_dir = "/lustre/orion/world-shared/mat190/exaam-challenge-problem/Stage1/"
    path_dir = os.path.abspath(path_dir)
    output_file_dir = os.path.join(path_dir, "cases", "exaconstit_chal_full", "")
    ...
    exaconstit_job_generation(input_cases, output_file_dir, False, False, False)
